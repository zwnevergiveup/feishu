...
public class ContactDetailActivity extends BaseActivity {
    ...
    protected void setupView() {
        ...
        if (model!=null) {
            mToolbar.setTitleText(model.friendNickName,getColor(R.color.pure_black),false);
            ((TextView) findViewById(R.id.contact_detail_name)).setText("Name："+model.friendNickName);
            ((TextView) findViewById(R.id.contact_detail_id)).setText("ID："+model.friendName);
